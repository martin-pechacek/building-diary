...
import cz.mp.construction_site_diary.enums.WeatherCodes;
...
public class WeatherServiceImpl implements WeatherService {
    ...
    public Optional<WeatherDto> getWeather(String postalCode, String country, LocalDate date) {
        try {
            ...
            Float temperature = Optional.ofNullable(response.daily().temperature2mMean())
    ...
    private record DailyWeather(
            @JsonProperty("temperature_2m_mean") List<Float> temperature2mMean,
